        ...
        case 'success':{
            ...
            if (result) {
                ...
                if(value.user.newpassword === value.user.newpasswordcheck){
                    // update new password
                    const newPasswordEncrypted = await encryptPassword(value.user.newpassword)
                    const {
                        data: { message, content },
        ...
        <Layout className="site-layout">
            ...
            >
                ...
                >
                    ...
                    <List.Item>
                        <Button onClick={()=>setChangePwdModalOpen(true)}>Change Password</Button>
                    </List.Item>
                </List>
            </Content>
            <EditAccModal
